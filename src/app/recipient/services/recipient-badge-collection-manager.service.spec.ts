...
xdescribe('RecipientBadgeCollectionManger', () => {
		...
		(recipientBadgeCollectionManager: RecipientBadgeCollectionManager) => {
			...
			return Promise.all([
				...
				verifyEntitySetWhenLoaded(
					recipientBadgeCollectionManager.recipientBadgeCollectionList,
					testData.apiCollections
				),
			]);
		}
	));

	it('should retrieve collections on subscription', inject(
		[RecipientBadgeCollectionManager],
		(recipientBadgeCollectionManager: RecipientBadgeCollectionManager) => {
			const testData = buildTestRecipientBadgeCollections();
	...
	it('should add a new collections successfully', inject(
		[RecipientBadgeCollectionManager],
		(recipientBadgeCollectionManager: RecipientBadgeCollectionManager) => {
			const testData = buildTestRecipientBadgeCollections();
			...
			return Promise.all([
				...
				verifyEntitySetWhenLoaded(recipientBadgeCollectionManager.recipientBadgeCollectionList, [
					existingRecipientBadgeCollection,
				])
					.then((recipientBadgeCollectionsList) =>
						recipientBadgeCollectionManager.createRecipientBadgeCollection(newRecipientBadgeCollection)
					)
					.then(() =>
						verifyManagedEntitySet(recipientBadgeCollectionManager.recipientBadgeCollectionList, [
							newRecipientBadgeCollection,
							existingRecipientBadgeCollection,
						])
					),
			]);
	...
	it('should delete a collection', inject(
		[RecipientBadgeCollectionManager],
		(recipientBadgeCollectionManager: RecipientBadgeCollectionManager) => {
			const testData = buildTestRecipientBadgeCollections();
