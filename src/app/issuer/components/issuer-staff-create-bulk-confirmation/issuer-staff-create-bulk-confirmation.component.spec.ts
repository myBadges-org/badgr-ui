...
import { IssuerStaffCreateBulkConfirmation } from './issuer-staff-create-bulk-confirmation.component';
...
describe('IssuerStaffCreateBulkConfirmation', () => {
	let fixture;
	let component;

	beforeEach(() => {
		TestBed.configureTestingModule({
			declarations: [IssuerStaffCreateBulkConfirmation],
			imports: [RouterTestingModule, CommonModule, BadgrCommonModule, ...COMMON_IMPORTS],
			providers: [...COMMON_MOCKS_PROVIDERS_WITH_SUBS],
			schemas: [CUSTOM_ELEMENTS_SCHEMA],
		}).compileComponents();
		fixture = TestBed.createComponent(IssuerStaffCreateBulkConfirmation);
