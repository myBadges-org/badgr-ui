...
import { IssuerStaffCreateBulkPreviewComponent } from './issuer-staff-create-bulk-preview.component';
...
describe('IssuerStaffCreateBulkPreviewComponent', () => {
	let fixture;
	let component;

	beforeEach(() => {
		TestBed.configureTestingModule({
			declarations: [IssuerStaffCreateBulkPreviewComponent],
			imports: [RouterTestingModule, CommonModule, ...COMMON_IMPORTS],
			providers: [...COMMON_MOCKS_PROVIDERS_WITH_SUBS],
			schemas: [CUSTOM_ELEMENTS_SCHEMA],
		}).compileComponents();
		fixture = TestBed.createComponent(IssuerStaffCreateBulkPreviewComponent);
	...
	it('should run #getRoleFromRow()', async () => {
		// const result = component.getRoleFromRow(row);
	});
