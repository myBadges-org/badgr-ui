...
import { IssuerStaffCreateBulkImportComponent } from './issuer-staff-create-bulk-import.component';
...
describe('IssuerStaffCreateBulkImportComponent', () => {
	let fixture;
	let component;

	beforeEach(() => {
		TestBed.configureTestingModule({
			declarations: [IssuerStaffCreateBulkImportComponent],
			imports: [RouterTestingModule, CommonModule, ...COMMON_IMPORTS],
			providers: [...COMMON_MOCKS_PROVIDERS_WITH_SUBS],
			schemas: [CUSTOM_ELEMENTS_SCHEMA],
		}).compileComponents();
		fixture = TestBed.createComponent(IssuerStaffCreateBulkImportComponent);
