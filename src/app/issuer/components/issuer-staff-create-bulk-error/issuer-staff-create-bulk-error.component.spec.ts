...
import { IssuerStaffCreateBulkError } from './issuer-staff-create-bulk-error.component';
...
describe('IssuerStaffCreateBulkError', () => {
	let fixture;
	let component;

	beforeEach(() => {
		TestBed.configureTestingModule({
			declarations: [IssuerStaffCreateBulkError],
			imports: [RouterTestingModule, CommonModule, ...COMMON_IMPORTS],
			providers: [...COMMON_MOCKS_PROVIDERS_WITH_SUBS],
			schemas: [CUSTOM_ELEMENTS_SCHEMA],
		}).compileComponents();
		fixture = TestBed.createComponent(IssuerStaffCreateBulkError);
