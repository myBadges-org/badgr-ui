...
import { IssuerStaffCreateBulkConfirmation } from './components/issuer-staff-create-bulk-confirmation/issuer-staff-create-bulk-confirmation.component';
import { IssuerStaffCreateBulkError } from './components/issuer-staff-create-bulk-error/issuer-staff-create-bulk-error.component';
import { IssuerStaffCreateBulkImportComponent } from './components/issuer-staff-create-bulk-import/issuer-staff-create-bulk-import.component';
import { IssuerStaffCreateBulkPreviewComponent } from './components/issuer-staff-create-bulk-preview/issuer-staff-create-bulk-preview.component';
...
@NgModule({
	...
	declarations: [
		...
		IssuerStaffCreateBulkPreviewComponent,
		IssuerStaffCreateBulkImportComponent,
		IssuerStaffCreateBulkError,
		IssuerStaffCreateBulkConfirmation,
	],
	exports: [],
	providers: [
