...
export function verifyUserEmail(email: UserProfileEmail, apiEmail: ApiUserProfileEmail) {
...
export const apiProfileEmails = [apiProfileEmail0, apiProfileEmail1, apiProfileEmail2, apiProfileEmail3];
